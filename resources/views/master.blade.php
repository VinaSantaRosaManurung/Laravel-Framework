...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="belajar">
                <a href="#">
                    <img src="template/images/icon/belajar.png" alt="Belajar Online" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
             ...
             <li class="nav-item">
             <a href="{{url('mata_pelajaran/')}}" class="nav-link">
             ...
             <li class="nav-item">
             <a href="{{url('jadwalbelajar/')}}" class="nav-link">
             <i class="zmdi zmdi-calendar-note"></i>
               <p>Data Jadwal Belajar</p>
             </a>
             </li>
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="template/images/icon/vina.jpg" alt="Vina" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Vina</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Vina Santa Rosa</a>
                                                    </h5>
                                                    <span class="email">vina18si@mahasiswa.pcr.ac.id</span>
                                                </div>
                                            </div>
